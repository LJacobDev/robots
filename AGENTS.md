...
The bundler will be Vite, and the testing framework will be Vitest. I want to consider whether it would be helpful to use Cypress for e2e testing or Supertest for API integration testing.
